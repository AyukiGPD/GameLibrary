...
//  @return コントローラーステート
//-----------------------------------------------------------------------------
XINPUT_STATE XInputPadManager::GetState() const
{
	return _state;
}
...
//  @param  [in]    pad キーコード
//-----------------------------------------------------------------------------
bool XInputPadManager::GetButtons(XINPUTPAD pad) const
{
...
//  @param  [in]    pad キーコード
//-----------------------------------------------------------------------------
bool XInputPadManager::GetTriggers(XINPUTPAD pad) const
{
...
//  @param  [in]    pad キーコード
//-----------------------------------------------------------------------------
bool XInputPadManager::GetReleases(XINPUTPAD pad) const
{
...
//  @brief  コントローラーの有無
//-----------------------------------------------------------------------------
bool XInputPadManager::IsController() const
{
...
//-----------------------------------------------------------------------------
bool XInputPadManager::IsVibrate() const
{
	return _isVibration;
}
